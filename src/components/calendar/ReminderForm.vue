        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" v-if="selectedReminder" @click="removeReminder">Remove Reminder</button>
                    <button type="button" class="btn btn-primary" @click="save"> {{ selectedReminder ? 'Update Reminder' : 'Add Reminder' }}</button>
...
export default {
    ...
    methods: {
        ...
        reminderObject() {
            ...
            return { dateKey: this.selectedDate.format('YYYY-MM-DD'), description: this.description, time: this.time, index: selectedReminder.index }
        },
        cleanInputs(){
            this.description = ''
            this.time = ''
